...
/// <summary>
/// In-memory database of FF1 items, loaded from embedded JSON resource.
/// </summary>
public sealed class ItemDb
{
    ...
    private ItemDb()
    {
        ...
        var resourceName = "FF1SaveEditor.Core.GameData.Items.json";
    ...
    public IEnumerable<ItemDef> GetEquippableBy(byte classId, ItemCategory category)
        => GetByCategory(category).Where(i => i.CanEquip(classId));
}
